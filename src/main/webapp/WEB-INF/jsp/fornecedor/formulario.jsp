                    ...
                    <ul class="nav navbar-nav side-nav" >
                        <li>
                            ...
                            <ul id="down-cliente" class="collapse">
                                ...
                                <li><a href="/sapato-pim-gerencia/cliente/pesquisar"><i class="fa fa-user-plus"></i>&nbsp;Cadastrar Cliente</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul id="down-fornecedor" class="collapse">
                                <li><a href="pesquisar"><i class="fa fa-search"></i>&nbsp;Pesquisar Fornecedor</a></li>
                                <li><a href="formulario"><i class="fa fa-ambulance"></i>&nbsp;Cadastrar Fornecedor</a></li>
                            </ul>
                        </li>
                        <li>
