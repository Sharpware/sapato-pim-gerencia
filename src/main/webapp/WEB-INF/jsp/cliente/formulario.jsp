        ...
        <form class="form-inline" id="codigo-pp-left"
            ...
            <div class="form-group">
                <label for="exampleInputName1">Nome</label> <br> <input
                    ...
                    name="cliente.nome" value="${cliente.nome}" maxlength="60"
                    style="width: 300px">&nbsp;&nbsp;
            </div>

            <div class="form-group">
                <label for="exampleInputEmail2">Email</label> <br> <input
                    type="email" class="form-control" id="exampleInputEmail2"
                    name="cliente.email" value="${cliente.email}"
                    placeholder="jane.doe@example.com" maxlength="40"
                    style="width: 250px">&nbsp;&nbsp;
            </div>
            ...
            <div class="form-group">
                <label for="exampleInputName1">CPF</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="cliente.cpf" value="${cliente.cpf}"
                    placeholder="---.---.---.--" maxlength="11" style="width: 130px">&nbsp;&nbsp;

            </div>

            <div class="form-group">
                <label for="exampleInputName1">Data de Nascimento</label> <br> <input
                    type="date" class="form-control" id="exampleInputName1"
                    name="cliente.dataNascimento" value="${cliente.dataNascimento}"
                    style="width: 160px">&nbsp;&nbsp;
            </div>
            ...
            <!--Telefone-->
            <div class="form-group">
                <label for="exampleInputName1">Telefone Residencial</label> <br>
                <input type="text" class="form-control" id="exampleInputName1"
                       name="telefone1.numero" value="${telefone1.numero}" placeholder="DDD + Tel" maxlength="12"
                       style="width: 130px">&nbsp;&nbsp;
            </div>

            <div class="form-group">
                <label for="exampleInputName1">Telefone Comercial</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="telefone2.numero" value="${telefone2.numero}" placeholder="DDD + Tel" maxlength="12"
                    style="width: 130px">&nbsp;&nbsp;
            </div>
            ...
            <div class="form-group">
                <label for="exampleInputName1">Celular</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="telefone3.numero" value="${telefone3.numero}" placeholder="DDD + Cel" maxlength="12"
                    style="width: 130px">&nbsp;&nbsp;
            </div>
            ...
            <div class="form-group">
                <label for="exampleInputName1">Logradouro</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.logradouro" value="${cliente.endereco.logradouro}"
            ...
            <div class="form-group">
                <label for="exampleInputName1">Número</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.numero" value="${cliente.endereco.numero}"
                    placeholder="Endereço" maxlength="100" style="width: 90px">&nbsp;&nbsp;
            </div>

            <div class="form-group">
                <label for="exampleInputName1">Complemento</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.complemento" value="${cliente.endereco.complemento}"
            ...
            <div class="form-group">
                <label for="exampleInputName1">Bairro</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.bairro" value="${cliente.endereco.bairro}"
            ...
            <div class="form-group">
                <label for="exampleInputName1">Cidade</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.cidade" value="${cliente.endereco.cidade}"
            ...
            <div class="form-group">
                <label for="exampleInputName1">CEP</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.cep" value="${cliente.endereco.cep}"
            ...
            <div class="form-group">
                <label for="exampleInputName1">UF</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="endereco.uf" value="${cliente.endereco.uf}" maxlength="2"
                    style="width: 50px">&nbsp;&nbsp;
            </div>
            ...
            <div class="form-group">
                <label for="exampleInputName1">Observação</label> <br> <input
                    type="text" class="form-control" id="exampleInputName1"
                    name="cliente.observacao" value="${cliente.observacao}"
